 ...
 * @author xuejiaming
 */
public class EasyKtSetIgnoreColumnsContributor extends EasyKtContributor {
    public EasyKtSetIgnoreColumnsContributor(@NotNull String insertWord, @NotNull String tipWord) {
