 ...
 * @author xuejiaming
 */
public class EasyKtWhereColumnsContributor extends EasyKtContributor {
    public EasyKtWhereColumnsContributor(@NotNull String insertWord, @NotNull String tipWord) {
