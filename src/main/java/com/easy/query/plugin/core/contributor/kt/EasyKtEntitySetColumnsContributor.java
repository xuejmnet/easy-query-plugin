 ...
 * @author xuejiaming
 */
public class EasyKtEntitySetColumnsContributor extends EasyKtContributor {
    public EasyKtEntitySetColumnsContributor(@NotNull String insertWord, @NotNull String tipWord) {
