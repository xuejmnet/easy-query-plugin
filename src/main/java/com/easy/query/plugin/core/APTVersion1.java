 ...
 * @author xuejiaming
 */
public class APTVersion1 {
    private static final Map<String, PropertyColumn> TYPE_COLUMN_MAPPING = new HashMap<>();
    private static final Logger log = Logger.getInstance(APTVersion1.class);

    static {

        TYPE_COLUMN_MAPPING.put("java.lang.Float", new PropertyColumnImpl("SQLNumberColumn", "java.lang.Float"));
        TYPE_COLUMN_MAPPING.put("java.lang.Double", new PropertyColumnImpl("SQLNumberColumn", "java.lang.Double"));
        TYPE_COLUMN_MAPPING.put("java.lang.Short", new PropertyColumnImpl("SQLNumberColumn", "java.lang.Short"));
        TYPE_COLUMN_MAPPING.put("java.lang.Integer", new PropertyColumnImpl("SQLNumberColumn", "java.lang.Integer"));
        TYPE_COLUMN_MAPPING.put("java.lang.Long", new PropertyColumnImpl("SQLNumberColumn", "java.lang.Long"));
        TYPE_COLUMN_MAPPING.put("java.lang.Byte", new PropertyColumnImpl("SQLNumberColumn", "java.lang.Byte"));
        TYPE_COLUMN_MAPPING.put("java.math.BigDecimal", new PropertyColumnImpl("SQLNumberColumn", "java.math.BigDecimal"));
        TYPE_COLUMN_MAPPING.put("java.lang.Boolean", new PropertyColumnImpl("SQLBooleanColumn", "java.lang.Boolean"));
        TYPE_COLUMN_MAPPING.put("java.lang.String", new PropertyColumnImpl("SQLStringColumn", "java.lang.String"));
        TYPE_COLUMN_MAPPING.put("java.util.UUID", new PropertyColumnImpl("SQLStringColumn", "java.util.UUID"));
        TYPE_COLUMN_MAPPING.put("java.sql.Timestamp", new PropertyColumnImpl("SQLDateTimeColumn", "java.sql.Timestamp"));
        TYPE_COLUMN_MAPPING.put("java.sql.Time", new PropertyColumnImpl("SQLDateTimeColumn", "java.sql.Time"));
        TYPE_COLUMN_MAPPING.put("java.sql.Date", new PropertyColumnImpl("SQLDateTimeColumn", "java.sql.Date"));
        TYPE_COLUMN_MAPPING.put("java.util.Date", new PropertyColumnImpl("SQLDateTimeColumn", "java.util.Date"));
        TYPE_COLUMN_MAPPING.put("java.time.LocalDate", new PropertyColumnImpl("SQLDateTimeColumn", "java.time.LocalDate"));
        TYPE_COLUMN_MAPPING.put("java.time.LocalDateTime", new PropertyColumnImpl("SQLDateTimeColumn", "java.time.LocalDateTime"));
        TYPE_COLUMN_MAPPING.put("java.time.LocalTime", new PropertyColumnImpl("SQLDateTimeColumn", "java.time.LocalTime"));



        TYPE_COLUMN_MAPPING.put("float", new PropertyColumnImpl("SQLNumberColumn", "java.lang.Float"));
        TYPE_COLUMN_MAPPING.put("double", new PropertyColumnImpl("SQLNumberColumn", "java.lang.Double"));
        TYPE_COLUMN_MAPPING.put("short", new PropertyColumnImpl("SQLNumberColumn", "java.lang.Short"));
        TYPE_COLUMN_MAPPING.put("int", new PropertyColumnImpl("SQLNumberColumn", "java.lang.Integer"));
        TYPE_COLUMN_MAPPING.put("long", new PropertyColumnImpl("SQLNumberColumn", "java.lang.Long"));
        TYPE_COLUMN_MAPPING.put("byte", new PropertyColumnImpl("SQLNumberColumn", "java.lang.Byte"));
...
//                }
    ...
    private static PropertyColumn getPropertyColumn(String fieldGenericType) {
        return TYPE_COLUMN_MAPPING.getOrDefault(fieldGenericType, new PropertyColumnImpl("SQLAnyColumn", fieldGenericType));
    }
