 ...
 * @author xuejiaming
 */
public class APTVersion2_8 {
    private static final Map<String, PropertyColumn> TYPE_COLUMN_MAPPING = new HashMap<>();
    private static final Logger log = Logger.getInstance(APTVersion2_8.class);
...
//                        aptFileCompiler.addImports("com.easy.query.core.proxy.columns.SQLQueryable");
            ...
            PsiFile psiProxyFile = VelocityUtils.render(project, context, Template.getTemplateContent("AptTemplate2_8" + suffix), proxyEntityName + suffix);
