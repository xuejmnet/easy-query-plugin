 ...
 * @author xuejiaming
 */
public class APTVersion2_9 {
    private static final Map<String, PropertyColumn> TYPE_COLUMN_MAPPING = new HashMap<>();
    private static final Logger log = Logger.getInstance(APTVersion2_9.class);
...
//                        aptFileCompiler.addImports("com.easy.query.core.proxy.columns.SQLQueryable");
            ...
            PsiFile psiProxyFile = VelocityUtils.render(project, context, Template.getTemplateContent("AptTemplate2_9" + suffix), proxyEntityName + suffix);
