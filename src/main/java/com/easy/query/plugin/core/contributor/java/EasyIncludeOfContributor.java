 ...
 * @author xuejiaming
 */
public class EasyIncludeOfContributor extends EasyContributor {

    public EasyIncludeOfContributor(@NotNull String insertWord, @NotNull String tipWord, boolean blockCode) {
